...
```
    ...
    <matplotlib.image.AxesImage at 0x7fdfd445b9b0>
...
```
    ...
    <matplotlib.image.AxesImage at 0x7fdfd0363400>
...
def compute_layer_style_cost(a_S, a_G):
    ...
    J_style_layer = tf.reduce_sum(tf.square(tf.subtract(GS, GG))) / (4 * np.square(n_C) * np.square(n_W * n_H) )
...
```
    ...
    <matplotlib.image.AxesImage at 0x7fdfd025da90>
